...
public class StatusAdapter extends RecyclerView.Adapter<StatusAdapter.StatusViewHolder> {
    ...
    public StatusViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new StatusViewHolder(
            ItemStatusBinding.inflate(LayoutInflater.from(context), parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull StatusViewHolder holder, int position) {
        ...
        boolean isVideo = path != null && path.endsWith(".mp4");
        holder.binding.ivPlayOverlay.setVisibility(
            isVideo ? android.view.View.VISIBLE : android.view.View.GONE);
        holder.binding.btnSave.setOnClickListener(v -> {
            com.videviewer.utils.FileUtils.saveToGallery(context, path);
    ...
    static class StatusViewHolder extends RecyclerView.ViewHolder {
        ...
        StatusViewHolder(ItemStatusBinding b) { super(b.getRoot()); binding = b; }
    }
}
