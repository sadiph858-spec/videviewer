...
public class VideoItem implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte((byte) (inVault ? 1 : 0));
    ...
    public void setFolderPath(String folderPath) { this.folderPath = folderPath; this.folder = folderPath; }
    public String getDisplayName() { return displayName; }
    public void setDisplayName(String displayName) { this.displayName = displayName; }
    public String getFolderName() { return folderName; }
    public void setFolderName(String folderName) { this.folderName = folderName; this.folder = folderName; }
    ...
    public String getFormattedSize() {
        ...
        if (size < 1024L * 1024 * 1024) return String.format("%.1f MB", size / (1024f * 1024));
